...
function RowColLayoutColWidthBreakpointExample() {
  return (
    <Container>
      <Row>
        <Col>Somos um grupo do 4º ano de Informática para Web que idealizou esse sistema visando ajudar todos aqueles que sentem dificuldades em escrever documentos formais em norma-ABNT. Buscando solucionar esse problema de forma fácil e intuitiva, nós desenvolvemos esta aplicação como nosso Projeto Multidisciplinar referente às matérias de Interfaces de Usuários, Programação Orientada a Serviços e Projeto de Desenvolvimento de Sistemas para Internet.</Col>
        <Col>
            <Card className='m-3'>
